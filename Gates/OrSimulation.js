 ...
 function pin(){
  ...
  document.getElementById("instruct").innerHTML='Observe the IC-7432 diagram,you can see that the gate for the selected input pin is highlighted. <b>Turn On Vcc</b>'
